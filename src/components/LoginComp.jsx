      ...
      <div className="bg-[#FAFAFA] mt-[1px]">
        <div className="max-w-xl mx-auto py-20 text-center ">
          <div className="bg-white p-4 rounded-md border-[1px]">
            ...
            <span className="text-[#3c40c6] hover:text-blue-300 cursor-pointer">
            ...
            <form className="my-6 px-6 ">
              <input
                ...
                className="border-[1px] w-full py-2 px-3 rounded-sm"
              />
              <input
                type="text"
                placeholder="Şifre"
              ...
              <div className="flex items-center justify-between mt-5 ">
                <div className="text-sm">
                  <a
                    to="/sifremiunuttum"
                    className="font-medium text-[#142850] hover:text-blue-500 cursor-pointer"
                  >
                    Şifreni mi unuttun?
                  </a>
                </div>
